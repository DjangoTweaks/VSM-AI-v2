...
ALTER TABLE public.voice_embeddings ADD COLUMN IF NOT EXISTS qdrant_id TEXT;
...
ALTER TABLE public.calls ADD COLUMN IF NOT EXISTS qdrant_id TEXT;
ALTER TABLE public.calls ADD COLUMN IF NOT EXISTS confidence_score NUMERIC(5,2);
